...
const items = [
  ...
  { to: "/admin/articles", label: "Cikkek", icon: Newspaper },
  ...
  { to: "/admin/pipeline", label: "Pipeline health", icon: Gauge },
];
      ...
      <aside className="hidden w-64 shrink-0 flex-col border-r border-border/50 bg-sidebar/60 backdrop-blur md:flex">
        ...
        <div className="border-t border-border/50 p-3 flex flex-col gap-2">
          <div className="flex items-center justify-between gap-2">
            <Link
              to="/"
              className="flex flex-1 items-center gap-2 rounded-lg px-3 py-2 text-xs text-muted-foreground hover:bg-muted hover:text-foreground"
            >
